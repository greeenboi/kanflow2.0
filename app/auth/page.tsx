          ...
          >
            <Card className="border-none bg-transparent w-full max-w-lg min-h-[605px]">
              ...
              <CardContent className="mx-auto">
                <Tabs defaultValue="login" className="w-full max-w-lg mx-auto overflow-hidden px-0.5">
                  <TabsList className="grid w-full grid-cols-2">
                    <TabsTrigger value="login">Login</TabsTrigger>
                    <TabsTrigger value="register">Register</TabsTrigger>
                  </TabsList>
                  <AnimatePresence mode="wait" initial={false}>
                    <TabsContent value="login" className="mt-6 h-[400px] w-[435px]">
                      <motion.div
                    ...
                    <TabsContent value="register" className="mt-6 h-[400px] w-[435px]">
                      <motion.div
                        variants={slideVariants}
                        initial="enter"
                        animate="center"
